...
public class HelloServiceLocator extends client.Service implements com.lti.services.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8081/simpleSoap/services/Hello";
    ...
    public com.lti.services.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.lti.services.HelloSoapBindingStub _stub = new com.lti.services.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.lti.services.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.lti.services.HelloSoapBindingStub _stub = new com.lti.services.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.lti.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.lti.com", "Hello"));
        }
